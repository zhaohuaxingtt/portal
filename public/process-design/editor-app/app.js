    ...
    function(
      ...
      $rootScope.$on('$includeContentLoaded', function(event) {
        if (!$rootScope.editorInitialized) {
          ...
          jQuery(window).resize(function() {
            ...
            var totalAvailable =
              jQuery(window).height() - offset.top - mainHeader.height() - 21
      ...
      $rootScope.editorFactory.promise.then(function() {
        ...
        eventMappings.forEach(function(eventMapping) {
          $rootScope.editor.registerOnEvent(eventMapping.oryxType, function(
            event
          ) {
        ...
        $rootScope.editor.registerOnEvent(
          ...
          function(event) {
            var validateButton = document.getElementById(
