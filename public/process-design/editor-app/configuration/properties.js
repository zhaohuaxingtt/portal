...
KISBPM.PROPERTY_CONFIG = {
  ...
  userid: {
    templateUrl: 'editor-app/configuration/properties/userid-template.html'
  },
  /*自定义*/
  responsiblepostcomplex: {
    readModeTemplateUrl:
      'editor-app/configuration/properties/default-value-display-template.html',
    writeModeTemplateUrl:
      'editor-app/configuration/properties/responsible-post-list-template.html'
  },
  createroperationcomplex: {
    readModeTemplateUrl:
      'editor-app/configuration/properties/default-value-display-template.html',
    writeModeTemplateUrl:
      'editor-app/configuration/properties/createroperation-template.html'
  }
}
