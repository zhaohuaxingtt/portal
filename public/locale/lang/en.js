;(function (global, factory) {
  ...
  var oldLanguage = {
    ...
    APPROVAL: {
      ...
      EXIT_EDIT: 'exit edit',
      EKL_ZP: 'task transfer',
      EKL_ZGZJ: 'give it to yourself'
    },
    ROLE: {
      ROLE_NAME: 'Role Name',
      ROLE_CODE: 'Role Code',
    ...
    EKL_WDYJ: 'my performance',
    EKL_YJJC: 'performance basis',
    EKL_MIAOSHU: 'describe',
    EKL_ZHUANGTAI: 'status',
    EKL_FAQIREN: 'initiator',
    EKL_DJLX: 'document type',
    EKL_YWLX: 'business type',
    EKL_CJRQ: 'create time',
    EKL_GXRQ: 'update time',
    EKL_GENGXINRIQIQI: 'start update time',
    EKL_GENGXINRIQIZHI: 'end update time',
    EKL_GXRQQZ: 'start and end of update date',
    EKL_CLGL: 'output management',
    EKL_NDMBGL: 'annual target management',
    EKL_CJNDMBGL: 'Create annual goals',
    EKL_XZYJJC: 'new performance basis',
    EKL_XZYJJCTIP:
      'please edit the basic information first, and then select the file to upload',
    EKL_XZYJFJTIP: 'No attachment, please upload',
    EKL_XZWJ: 'select file',
    EKL_PLJYSCLGL: 'batch budget output management',
    EKL_SCCL: 'upload output',
    EKL_XZMB: 'download template',
    EKL_FHSJ: 'go back',
    EKL_TZKS: 'notify department',
    EKL_NIANDUYEJIJICHU: 'nnual performance base',
    EKL_ZONGCHENCHENGSANJIANJICHUBIAO: 'parts foundation table',
    EKL_QITA: 'other',
    EKL_FQQR: 'Initiate confirmation',
    EKL_RWJZRQ: 'task deadline',
    EKL_GYS: 'supplier',
    EKL_CGGC: 'purchasing plant',
    EKL_QRZT: 'confirm status',
    EKL_FDJDCB: 'engine - battery pack',
    EKL_BSX: 'transmission case',
    EKL_PEIZ: 'configure',
    EKL_CXDM: 'model code',
    EKL_CPJZ: 'product family',
    EKL_LJHAO: 'part number',
    EKL_PLBJ: 'bulk edit',
    EKL_QRSL: 'confirmed quantity',
    EKL_QRJG: 'confirmed price',
    EKL_JGLY: 'price source',
    EKL_QRJGLY: 'confirmed price source',
    EKL_QNCL: 'annual output',
    EKL_SYH: 'index number',
    EKL_SHUL: 'quantity',
    EKL_JAGE: 'price',
    EKL_KSLJ: 'ksl price',
    EKL_KSLJLY: 'ksl price source',
    EKL_CKJG: 'reference price',
    EKL_CKJGLY: 'reference price source',
    EKL_CGY: 'buyer',
    EKL_CGCKJ: 'purchase reference price',
    EKL_JIJIA: 'base price',
    EKL_GZJD: 'track progress',
    EKL_LY:'sorce',
    EKL_CAOZ:'operation',
    EKL_BANBENHAO:'Version No',
    EKL_QUEREN:'confirm',
    EKL_SHANGCHUANREN:'Upload People',
    JANUARY: 'january',
    FEBRUARY: 'february',
    MARCH: 'march',
    APRIL: 'april',
