;(function (global, factory) {
  ...
  */
    ...
    EKL_CJRQ: '创建日期',
    EKL_GXRQ: '更新日期',
    EKL_GENGXINRIQIQI: '更新日期起',
    EKL_GENGXINRIQIZHI: '更新日期止',
    EKL_GXRQQZ: '更新日期起止',
    EKL_CLGL: '产量管理',
    EKL_NDMBGL: '年度目标管理',
    EKL_CJNDMBGL: '创建年度目标',
    EKL_XZYJJC: '新增业绩基础',
    EKL_XZYJJCTIP: '请先编辑基础信息，再选取⽂件上传',
    EKL_XZYJFJTIP: '暂无附件，请上传',
    EKL_XZWJ: '选择文件',
    EKL_PLJYSCLGL: '批量件预算产量管理',
    EKL_SCCL: '上传产量',
    EKL_XZMB: '下载模板',
    EKL_FHSJ: '返回上级',
    EKL_TZKS: '通知科室',
    EKL_NIANDUYEJIJICHU: '年度业绩基础',
    EKL_ZONGCHENCHENGSANJIANJICHUBIAO: '总成散件基础表',
    EKL_QITA: '其他',
    EKL_FQQR: '发起确认',
    EKL_RWJZRQ: '任务截止日期',
    EKL_GYS: '供应商',
    ...
    MT_WENJIANDAXIAOXIANZHIORZHIZHICHIPDFWENJIAN:"文件大小最大限制10MB | 只支持pdf文件",
