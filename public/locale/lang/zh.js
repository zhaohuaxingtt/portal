;(function (global, factory) {
  ...
  */
    ...
    SUPPLIER_TIAOZHENGHOUPINGJI:'调整后评级',
    ...
    // 结算-settlement 新增字段
    SETTLEMENT_GAILAN: "概览",
    ZHIFUSHENQINGLIEBIAO:"支付申请列表",
    DAIZHIFUSHETONG:'合同列表',
    ZHIFUSHENQINGHAO:'支付申请号',
    HETONGBIANHAO: '合同编号',
    ZFSQ_CJRQ: '创建日期',
    HETONGHUOBI: '合同货币',
    SHIFOUYOUYUZHI: '是否有预支',
    SHENQINGBUMEN: '申请部门',
    DANJULEIXING: '单据类型',
    GONGYINGSHANGBIANHAO: '供应商编号',
    GONGYINGSHANGMINGCHENG: '供应商名称',
    DAIZHIFUSHULIANG: '待支付数量',
    DAIZHIFUJINE: '待支付金额',
    CHUANGJIANSHENQING: '创建支付申请',
    TOUBUXINXI: '头部信息',
    GONGYINGSHANGYINHANGZHANGHAO: '供应商银行账号',
    LIANXIRENDIANHUA: '联系人电话',
    GONGYINGSHANGYINHANGMINGCHENG: '供应商银行名称',
    LIANXIRENYOUJIAN: '联系人邮件',
    FUKUANFANGSHIJIQIXIAN: '付款方式及期限',
    BEIZHU: '备注',
    FUJIAN: '附件',
    HANGXIANGMUXINXI: '行项目信息',
    HANGXIANGMUBIANHAO: '行项目编号',
    HANGXIANGMUMINGCHENG: '行项目名称',
    BENCIZHIFUSHULIANG: '本次支付数量',
    DINGDANHANGXIANGMUZONGSHU: '订单行项目总数',
    DANWEI: '单位',
    JIAGEDANWEI: '价格单位',
    DANJIA: '单价',
    BENCIZHIFUJINE: '本次支付金额',
    DINGDANHANGXIANGMUZONGJINE: '订单行项目总金额',
    HUOBI: '货币',
    HETONGMINGCHENG: '合同名称',
    JIAFANG: '甲方',
    HETONGRIQI: '合同日期',
    JIESUANZHUANGTAI: '结算状态',
    BUHANSHUIZONGJINE: '不含税总金额',

    ZHIFUXINXI: '支付信息',
    SHENPIXIANGGUANXINXI: '审批相关信息',
    FAPIAOXINXI: '发票信息',
    settlement: {
      yes: '是',
      no: '否',
      approvelComment: '审批注释',
      search: {
        type: '合同类型'
      },
      tip: {
        submit: '您确认提交支付申请? 确认支付申请内填写的联系人, 邮箱及支付支付数量都填写正确!',
        cancel: '您确认取消支付申请? 此操作无法撤销!',
        delete: '您确认要删除此支付申请吗? 此操作无法撤销!',
        invoice_delete: '您确认要删除这些合同吗? 此操作无法撤销!'
      },
      title: {
        note: '添加审批注释'
      },
      ...
      ov: {
        ...
        pay_apply: '支付申请',
        contract_qty: '合同数量',
        pay_apply_qty: '支付申请数量',
        settleable_contract: '可结算合同',
        draft: '暂存',
        approving: '审批中',
        'return-rejected': '审批退回-拒绝',
        'return-material': '审批退回-补充材料',
        'pending-sending': '待送票',
        cancelled: '已取消',
        'comparing-email': '比对失败',
        received: '已收票',
        'audit-invoice': '问题发票',
      },
      rules: {
      ...
      status: {
        ...
        comparing: '比对中',
        received: '已收票',
        'comparing-email': '比对失败-邮件通知',
        'comparing-rejected': '比对失败-拒绝',
        'audit-passed': '审核通过',
        'audit-invoice': '审核不通过-问题发票',
        'written-off': '冲销',
        cancelled: '已取消',
        'audit-rescan': '审核不通过-补充材料(重扫)',
        'audit-norescan': '审核不通过-补充材料(不重扫)',
        'audit-reject': '审核不通过-拒绝',
        cancel: '取消支付申请',
        delete: '刪除',
        cancellation: '作废'
      }
    ...
    // 按钮
    JIANCHA: '检查',
    SETTLEMENT_BAOCUN: '保存',
    SETTLEMENT_TIJIAO: '提交',
    SETTLEMENT_SHANCHU: '删除',
    SETTLEMENT_QUXIAOZHIFUSHENQING: '取消支付申请',
    SETTLEMENT_TUICHU: '关闭',
  }
