export default {
  ...
  YUZHIXISHU: 'Coefficient',
  '载体费用':'Substrate Exw',
  '载体税率(%)':'Substrate ImpDuty',
  '载体管理费率(%)':'Substrate Handling',
  '贵金属管理费率(%)':'Pgm Handling',
  '制造费用':'Manufacture Exw',
  '运输费用':'Transport Exw',
  '版本':'Version',
  '升版':'Upgrade',
  '原材料用量来源':'Raw Material Weight Source',
  '结算数据来源':'Settle Accounts Quantity',
  '均值偏移量': 'Avg. Offset',
  '均值计算周期':'Avg. Period',
  YUZHIBUCHALUOJI: 'Threshold Offset Logic',
  BUCHABAIFENBI: 'Compensation%',
  ...
  GUANLIANSHENGPIRENSHENGPIJILU:'Approver & Approval Status',
  WEIHUMTZSHENGQINGDANXIANGQING: 'MTZ App. Sheet Detail',
  MTZSHENGQINGDANXIANGQING: 'MTZ App. Sheet Detail',
  SHENGPIRENSHENGPIJILU: 'Approver & Approval Status',
  SHENGCHENGJUECEZILIAO:'Decision Making Data',
