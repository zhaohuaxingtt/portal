export default [
      ...
      children: [
        {
          ...
          component: () => import("@/views/newsManagement/content/manage/index.vue"),
        },
        {
          path: "/news/label",
          name: "newsLabel",
    ...
    },
    {
      ...
      component: () => import("@/views/newsManagement/content/addAndEdit/index.vue"),
    },
    {
    ...
    },
    {
      ...
      component: () => import("@/views/newsManagement/notice/components/toView.vue"),
    },
    {
      // 用户模块
