...
const VUE_APP_PARTSFOLDER = axios(process.env.VUE_APP_PARTLIFECYCLEAPI + '/partsFolder')
const VUE_APP_PARTSCOLLECT = axios(process.env.VUE_APP_PARTLIFECYCLEAPI + '/partsCollect')
const VUE_APP_RELATIONPARTS = axios(process.env.VUE_APP_PARTLIFECYCLEAPI + '/relationParts')
const VUE_APP_PARTSCARD = axios(process.env.VUE_APP_PARTLIFECYCLEAPI + '/partsCard')
