...
<template>
	<div class="baseInfo">
		...
		<buyer ref="buyer" :supplierData="supplierComplete.supplierDTO" disabled 
			class="margin-bottom20"></buyer>
		<companyProfile ref="companyProfile" :country="country" :supplierData="supplierComplete" :fromGroup="fromGroup">
		</companyProfile>
		<!-- 经营状态 -->
		<operationStatus ref="operationStatus" :supplierData="supplierComplete" :fromGroup="fromGroup" v-if="isPP">
		</operationStatus>
		<!-- 开户银行 -->
		<opneBank ref="opneBank" :country="country" :supplierData="supplierComplete" :fromGroup="fromGroup"></opneBank>
		<!-- 供货状态 -->
		<supplyStatus ref='supplyStatus'  :supplierData="supplierComplete" :fromGroup="fromGroup">
		</supplyStatus>
		<!-- 内部评价 -->
