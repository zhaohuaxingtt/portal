...
export const supplierDirectoryTableTitle = [
  { props: 'contactType', name: '联系人类型', key: 'SUPPLIER_LIANXIRENLEIXING' },
  { props: 'nameZh', name: '联系人姓名', key: 'SUPPLIER_LIANXIRENXINGMING', required: true },
...
export const supplierUserNameTableTitle = [
  { props: 'isDefault', name: '是否为主用户', width: 120, key: 'SUPPLIER_ISWEIZHUYONGHU' },
  {
    props: 'nameZh', name: '联系人姓名', key: 'SUPPLIER_LIANXIRENXINGMING', required: true, width: 140
  },
  { props: 'designation', name: '职位', key: 'SUPPLIER_ZHIWEI' },
  { props: 'dept', name: '部门', key: 'SUPPLIER_BUMEN' },
  { props: 'telephoneAreaCode', name: '区号', key: 'SUPPLIER_QUHAO' },
  { props: 'telephone', name: '联系电话', key: 'SUPPLIER_LIANXIDIANHUA', required: true },
  {
    props: 'email', name: '电子邮件', key: 'SUPPLIER_DIANZIYOUJIAN', width: 150, required: true,
    rule: [{ pattern: /^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/, message: '请输入正确的电子邮件', trigger: 'blur' }]
  },
  { props: 'userName', name: '用户登录名', key: 'SUPPLIER_YONGHUDENGLUMING', tooltip: true },
  { props: 'isActivity', name: '是否有效', key: 'SUPPLIER_SHIFOUHUODONG', tooltip: true },
  { props: 'isExpire', name: '是否超期', key: '', tooltip: true },
  { props: 'expireDate', name: '超期时间', key: '', tooltip: true },
  { props: 'loginDate', name: '登录CSC系统时间', width: 170, key: '', tooltip: true },
