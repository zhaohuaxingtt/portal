...
export const subSupplierTableTitle = [
  ...
  {
    props: 'mobilePhone', name: '手机号码', width: 150, key: 'SUPPLIER_SHOUJIHAOMA',
    rule: [
      {
  ...
  {
    props: 'email', name: '电子邮件', width: 150, key: 'SUPPLIER_DIANZIYOUJIAN',
    rule: [
      {
...
export const paymentTableTitle = [
  {props: 'payTime', name: '付款记录-时间', key: 'SUPPLIER_FUJIANJILUSHIJIAN'},
