            ...
            <template v-if="scope.row.templateId == '21'">
              <div class="flex">
                <iButton
                  ...
                  v-permission="
                    SUPPLIER_RELATEDACCESSORY_UPLOADATTACHMENTS_QUERENBINGFABU
                  "
                  :disabled="disabled"
                ...
                <iButton
                  ...
                  class="openLinkText text-500"
                  v-permission="
                    SUPPLIER_RELATEDACCESSORY_UPLOADATTACHMENTS_CHAKANYIFABU
                  "
                  @click="viewPublish(scope.row)"
                  >查看已发布</iButton
                >
              </div>
            </template>
            <span
              v-else-if="scope.row.isCommitment"
