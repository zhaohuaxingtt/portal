  ...
  methods: {
    ...
    powerBiUrl() {
      let params = {
        ...
        reportId: process.env.NODE_ENV == 'production' ? '3ce8a5ad-1c94-41dc-b844-f5baf9441ecc' : '90f82db8-cc99-42a6-914a-3180e82585cc',
        datasets: process.env.NODE_ENV == 'production' ? ['93fa7924-a4c1-4c91-a763-55b68b996c47'] : ['c2e4ff2e-50ba-4686-a042-0416ab276d06'],
