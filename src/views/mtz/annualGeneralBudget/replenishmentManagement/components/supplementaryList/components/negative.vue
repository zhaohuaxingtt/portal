<template>
  <div style="padding-bottom:5px;">
        <el-input type="textarea" :rows="8" placeholder="请输入拒绝原因…" v-model="textarea"></el-input>
...
export default {
    ...
    data(){
        return{
            uploadUrl:process.env.VUE_APP_MTZ + "/mtzBalance/uploadRejectReasonAttach",
            uploadForm:{},
            textarea:"",
            tableListData:[],
    ...
    methods:{
        ...
        getData(){
            this.loading = true;
            getRejectReasonAndFile(this.mtzDocId).then(res=>{
