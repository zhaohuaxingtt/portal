...
export const ruleTableTitle1 = [
  ...
  {props: 'materialName', name: '中类名称', key: 'ZHONGLEIMINGCHENG', width: 150},
...
export const ruleTableTitle2 = [
  ...
  {props: 'priceMeasureUnit', name: '基价计量单位', key: 'JIJIAJILIANGDANWEI',width:90},
  ...
  {props: 'compensationRatio', name: '补差系数', key: 'BUCHAXISHU',width:60},
  {props: 'compensationPeriod', name: '补差周期', key: 'BUCHAZHOUQI',width:60},
  {props: 'threshold', name: '阈值', key: 'YUZHI',width:40},
  {props: 'thresholdCompensationLogic', name: '阈值补差逻辑', key: 'YUZHIBUCHALUOJI',width:90},
...
export const partTableTitle2 = [
  ...
  {props: 'partUnit', name: '零件数量单位', key: 'LINGJIANSHULIANGDANWEI',width:85},
  {props: 'dosage', name: '用量', key: 'YONGLIANG',width:35},
  {props: 'dosageMeasureUnit', name: '用量计量单位', key: 'YONGLIANGJILIANGDANWEI',width:65},
  ...
  {props: 'materialCode', name: '原材料编号', key: 'YUANCAILIAOBIANHAO',width:70},
  {props: 'materialName', name: '原材料', key: 'YUANCAILIAO',width:45},
  {props: 'price', name: '基价', key: 'JIJIA',width:32},
  {props: 'priceMeasureUnit', name: '基价计量单位', key: 'JIJIAJILIANGDANWEI'},
  {props: 'priceSource', name: '市场价来源', key: 'SHICHANGJIALAIYUAN',width:75},
  {props: 'tcCurrence', name: '货币', key: 'HUOBI',width:40},
  {props: 'tcExchangeRate', name: '汇率', key: 'MTZHUILV',width:32},
  {props: 'compensationPeriod', name: '补差周期', key: 'BUCHAZHOUQI',width:60},
  {props: 'compensationRatio', name: '补差系数', key: 'BUCHAXISHU',width:55},
