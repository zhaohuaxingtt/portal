    ...
    <div class="sub_title">
      ...
      >
        <div class="sub_img">
          <img
            class="img_front"
            v-if="indexValue === index ? false : true"
            :src="require('@/assets/images/icon/click-gray.png')"
          />
          <img
            class="img_front"
            v-else
  ...
  methods: {
    ...
    handleSelectionChange(val) {
      if (val.length > 1) {
        ...
        this.$refs.moviesTable.$children[0].$children[0].toggleRowSelection(
          duoxuans
        )
      } else {
        this.selectData = val
