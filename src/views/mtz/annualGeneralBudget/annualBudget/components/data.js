 ...
 * @LastEditTime: 2022-03-02 14:53:19
...
export const tableTitleBuyer = [
  ...
  {
    props: 'endForecastAmount',
    name: '预算金额（百万）',
    key: 'YUSUANJINEBAIWAN'
  },
...
export const tableTitleLeader = [
  ...
  { props: 'demandVersion', name: '用量版本', key: '', width: 180 },
  { props: 'createDate', name: '创建日期', key: '', width: 150 },
  { props: 'updateDate', name: '最后更新日期', key: '' },
  { props: 'startForecastAmount', name: '初始预算金额', key: '', width: 180 },
  { props: 'endForecastAmount', name: '最终预算金额', key: '', width: 180 },
...
export const materialGroupTableTitle = [
  ...
  {
    props: 'materialMediumName',
    name: '原材料中类',
    key: 'YUANCAILIAOZHONGLEI'
  },
  {
    props: 'initPrTotal',
    name: '初始预算金额（百万）',
    key: 'CHUSHIYUSUANJINE',
    width: 200
  },
