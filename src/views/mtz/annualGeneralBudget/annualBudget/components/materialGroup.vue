<!--
 * @Author: youyuan
 * @Date: 2021-08-30 15:28:16
 * @LastEditTime: 2021-11-01 18:33:00
 * @LastEditors: Please set LastEditors
 * @Description: 材料组
 * @FilePath: \重庆软维科技\front-portal\src\views\mtz\annualGeneralBudget\annualBudget\components\materialGroup.vue
-->
<template>
  <div>
    <div class="searchBox">
      ...
      <div class="contentBox">
        ...
        :tableTitle="materialGroupTableTitle"
...
import { materialGroupTableTitle } from './data'
import { fetchMaterialData, fetchMaterialExport, fetchUserInfos } from '@/api/mtz/annualGeneralBudget/annualBudget.js'
  ...
  methods: {
    ...
    getTableData() {
      return new Promise(resolve => {
        ...
        fetchMaterialData(params).then(res => {
          if(res && res.code == 200) {
            this.params = {
              ...res.data
            }
