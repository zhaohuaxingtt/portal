...
<template>
  <div>
    <iDialog :title="editData.buyerName + ' ' + editData.departments" :visible.sync="value" width="80%" @close='closeDiolog'>
      <div class="dialogBox">
        <div class="searchBox">
          <el-form :inline="true" :model="searchForm" label-position="top" class="demo-form-inline">
            ...
            <el-form-item style="marginRight:68px" :label="language('CAILIAOZHONGLEI', '材料中类')">
              <!-- <iSelect 
