  ...
  <iCard>
    <div class="contentBox">
      <div class="tableOptionBox">
        ...
        <iButton v-if="!editMode"
                 @click="handleDel">{{language('SHANCHU', '删除')}}</iButton>
        <iButton v-if="!editMode"
      ...
      <tableList class="margin-top20"
        ...
        <template #linieName="scope">
          <div v-if="editMode">
            <iSelect :value="scope.row.linieName"
                     filterable
                     remote
        ...
        <template #materialMinorName="scope">
          <div v-if="editMode">
            <iSelect :value="scope.row.materialMinorName"
                     filterable
                     remote
                     :placeholder="language('QINGXUANZE','请选择')"
        ...
        <template #mtzCategoryName="scope">
          <div v-if="editMode">
            <iSelect :value="scope.row.mtzCategoryName"
                     filterable
                     remote
                     :placeholder="language('QINGXUANZE','请选择')"
        ...
        <template #sectionName="scope">
          <div v-if="editMode">
            ...
            <iSelect v-if="scope.row.linieId && scope.row.linieName"
                     :value="scope.row.sectionName"
                     @change="changeDept($event, scope.row)">
              <el-option :value="scope.row.sectionCode"
                         :label="scope.row.sectionName"></el-option>
            </iSelect>
            <iSelect v-else
                     :value="scope.row.sectionName"
                     filterable
        ...
        <template #brandName="scope">
          <div v-if="editMode">
            <iSelect :value="scope.row.brandName"
                     filterable
                     remote
                     :placeholder="language('QINGXUANZE','请选择')"
    ...
    <addDialog :value="dialogParams.visible"
