 ...
 * @LastEditTime: 2021-10-26 10:24:49
...
<template>
  <div>
    <iDialog :title="language('XINZENG','新增')" :visible.sync="value" width="50%" @close='closeDiolog'>
      <el-form :inline="true" ref="addOther" :model="form" :rules="rules" label-position="top" class="demo-form-inline">
        <el-row>
          <el-col :span="8">
            <el-form-item :label="language('CAIGOUYUAN', '采购员')">
              <iSelect 
              :value="form.linieName" 
              ...
              value-key="linieId">
                ...
                <el-option v-for="(item, index) in linieList" :key="index" :value="{linieId: item.linieId, linieName: item.linieName, departId: item.departId, departName: item.departName, departNameEn: item.departNameEn}" :label="item.linieName"></el-option>
              </iSelect>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item :label="language('CAILIAOZHONGLEI', '材料中类')" prop="materialMinorName">
              <iSelect
              :value="form.materialMinorName"
              filterable
              remote
              :placeholder="language('QINGXUANZE','请选择')"
          ...
          <el-col :span="8">
            <el-form-item :label="language('YUSUANJINE', '预算金额')" prop="budget">
              <iInput v-float.expression="2" v-model="form.budget" :placeholder="language('QINGSHURU','请输入')"></iInput>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item :label="language('MTZCAILIAOZU', 'MTZ材料组')" prop="mtzCategoryName">
              <iSelect
              :value="form.mtzCategoryName"
              filterable
              remote
              :placeholder="language('QINGXUANZE','请选择')"
          ...
          <el-col :span="8">
            <el-form-item :label="language('KESHI', '科室')" prop="sectionName">
              <iSelect 
              v-if="form.linieId && form.linieName"
              :value="form.sectionName" 
              @change="changeDept($event, form)">
                <el-option :value="form.sectionCode" :label="form.sectionName"></el-option>
              </iSelect>
              <iSelect
                v-else
                :value="form.sectionName"
          ...
          <el-col :span="8">
            <el-form-item :label="language('PINGPAI', '品牌')" prop="brandCode">
              <iSelect
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item :label="language('BEIZHU', '备注')">
              <iInput class="remarkIpt" type="textarea" v-model="form.mark" :placeholder="language('QINGSHURU','请输入')"></iInput>
            </el-form-item>
          </el-col>
        </el-row>        
      </el-form>
