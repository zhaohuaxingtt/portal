    ...
    <iCard class="OrganizationTable">
      <div class="export">
        ...
        <div>
          ...
          <iButton @click="handleSeePartsRelationship" v-permission="PORTAL_MTZ_SEARCH_MTZLINGJIANCHAXUN_CKYECJLJGX">查看一/二次件零件关系</iButton>
          ...
          <iButton @click="takeEffect(1)" v-permission="PORTAL_MTZ_SEARCH_MTZLINGJIANCHAXUN_SHENGXIAO">{{language('SHENGXIAO', '生效')}}</iButton>
          <iButton @click="takeEffect(0)" v-permission="PORTAL_MTZ_SEARCH_MTZLINGJIANCHAXUN_SHIXIAO">{{language('SHIXIAO', '失效')}}</iButton>
          <iButton @click="handleExportAll" v-permission="PORTAL_MTZ_SEARCH_MTZLINGJIANCHAXUN_DAOCHUDANGYE">{{language('DAOCHUDANGYE', '导出当页')}}</iButton>
        </div>
      </div>
      <div>
