 ...
 * @LastEditTime: 2021-10-13 16:20:05
      ...
      h(
        ...
        [
          h('i', {
            ...
            style: 'color: #A0BFFC; font-size: 16px; margin-top: 2px; margin-left: 10px;'
          })
        ]
      )
    ]
...
export const tableSetting = [
  ...
  {prop: 'ruleNo',label: '规则编号',i18n:'规则编号',align: 'center',width: 150},
  {prop: 'sapCode',label: '供应商编号',i18n: '供应商编号',align: 'center',width: 150},
  {prop: 'supplierName',label: '供应商名称',width: '100px',align: 'center',i18n: '供应商名称',width: 150},
  {prop: 'materialCode',label: '原材料牌号',align: 'center',i18n: '原材料牌号',width: 150},
  // {prop: 'materialCategory',label: '中类名称',i18n: '中类名称',align: 'center',width: 150},
  {prop: 'materialName',label: '原材料名称',i18n: '原材料名称',align: 'center',width: 150},
  {prop: 'price',label: '基价',align: 'center',i18n: '基价',width: 150},
  {prop: 'priceMeasureUnit',label: '基价计量单位',align: 'center',i18n: '基价计量单位',width: 150},
  {prop: 'tcCurrence',label: '货币',align: 'center',i18n: '货币',width: 150},
  {prop: 'tcExchangeRate',label: '汇率',align: 'center',i18n: '汇率',},
  {prop: 'marketSource',label: '市场价来源',align: 'center',i18n: '市场价来源',width: 150},
  {prop: 'compensationRatio',label: '补差系数',align: 'center',i18n: '补差系数',width: 150},
  {prop: 'threshold',label: '阈值',align: 'center',i18n: '阈值',},
  {prop: 'thresholdCompensationLogic',label: '阈值补差逻辑',align: 'center',i18n: '阈值补差逻辑',width: 150},
  {prop: 'compensationPeriod',label: '补差周期',align: 'center',i18n: '补差周期',width: 150},
  {prop: 'buyerName',label: 'MTZ定点采购员',align: 'center',i18n: 'MTZ定点采购员',width: 180},
  ...
  { prop: 'palladiumPrice',label: '钯基价',align: 'center',i18n: '钯基价',tooltip:true, width:100, headerRender: (h, {column}) => renderIcon(h, column, 2)},
  { prop: 'palladiumDosage',label: '钯用量',align: 'center',i18n: '钯用量',tooltip:true, width:100, headerRender: (h, {column}) => renderIcon(h, column, 2)},
  { prop: 'rhodiumPrice',label: '铑基价',align: 'center',i18n: '铑基价',tooltip:true, width:100, headerRender: (h, {column}) => renderIcon(h, column, 3)},
  { prop: 'rhodiumDosage',label: '铑用量',align: 'center',i18n: '铑用量',tooltip:true, width:100, headerRender: (h, {column}) => renderIcon(h, column, 3)},
]
