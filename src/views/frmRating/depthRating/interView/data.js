...
export const groupShareholder=[
	...
	{props: 'shareholderContribution', name: '持股金额', key: 'SPR_FRM_DEP_CGJE'},
...
export const organizationDetail=[
	...
	{props: 'managerNumber', name: '管理人员', type: 'input',key:'SPR_FRM_DEP_GLRY'},
	{props: 'developerNumber', name: '研发人员', type: 'input',key:'YANFARENYUAN'},
	{props: 'productionNumber', name: '生产人员', type: 'input',key:'SPR_FRM_DEP_SCRY'},
	{props: 'legalRepresentative', name: '法定代表人', type: 'input',key:'LegalPerson'},
	{props: 'legalRepresentativeDateBirth', name: '出生日期', type: 'date',key:'SPR_FRM_DEP_CSRQ'},
	{props: 'legalRepresentativeSex', name: '性别', type: 'select',select:'EMPLOYEE_GENDER',key:'XINGBIE'},
	{props: 'flegalRepresentativeWorkYear', name: '从业年限', type: 'input',key:'SPR_FRM_DEP_CYNX'},
	{props: 'actualController', name: '实际控制人', type: 'input',key:'SPR_FRM_DEP_SJKZR'},
	{props: 'actualControllerDateBirth', name: '出生日期', type: 'date',key:'SPR_FRM_DEP_CSRQ'},
	{props: 'actualControllerSex', name: '性别', type: 'select',select:'EMPLOYEE_GENDER',key:'XINGBIE'},
	{props: 'actualControllerWorkYear', name: '从业年限', type: 'input',key:'SPR_FRM_DEP_CYNX'},
	{props: 'generalManager', name: '总经理', type: 'input',key:'SPR_FRM_DEP_ZJL'},
	{props: 'generalManagerDateBirth', name: '出生日期', type: 'date',key:'SPR_FRM_DEP_CSRQ'},
	{props: 'generalManagerSex', name: '性别', type: 'select',select:'EMPLOYEE_GENDER',key:'XINGBIE'},
	{props: 'generalManagerWorkYear', name: '从业年限', type: 'input',key:'SPR_FRM_DEP_CYNX'},
	{props: 'isSetTradeUnion', name: '是否设置工会', type: 'select',select:'TURE_FALSE', key:'SHIFOUSHEZHIGONGHUI'},
]
	
// 主要产品及占比、产品工艺
export const mainProduct =[
	{props: 'businessProductName', name: '业务或产品', key: 'SPR_FRM_DEP_YWHCP'},
...
export const mainCustomers =[
	...
	{props: 'amountOfSupply', name: '最新年度供货金额', key: 'SPR_FRM_DEP_ZXNDGHJE'},
...
export const mainSupplier =[
	...
	{props: 'amountOfSupply', name: '最新年度销售金额', key: 'SPR_FRM_DEP_ZXNDXSJE'},
	{props: 'paymentDays', name: '账期', key: 'ZHANGQI'},
	{props: 'cashNotesPro', name: '现金票据比例', key: 'XIANJINGPIAOJUJINGLI'},
]		
