...
<template>
	<iPage>
		<div class="navBox flex-between-center">
			...
			<iNavMvp :list="depthReportRouter" :lev='1' routerPage :query="query"/>

			<div class="flex-align-center">
				<iNavMvp :list="interViewTabList" :lev='2' right @change="changeNav" />
				<!--保存-->
				<iButton class="margin-left30" @click="save">{{ $t('LK_BAOCUN') }}</iButton>
				<!--提交审核-->
		...
		<basic v-if="currentNav==1" ref="basic"></basic>
		<business v-else-if="currentNav==2" ref="business"></business>
		<finance v-else-if="currentNav==3" ref="finance"></finance>
	</iPage>
</template>
