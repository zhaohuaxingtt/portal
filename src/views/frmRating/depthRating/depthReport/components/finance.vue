...
<template>
	<div>
		<!-- 提示信息 -->
		<iCard title="提示信息" collapse class="margin-top20">
			<iInput :disabled="isDisabled" type='textarea' :autosize='rowRange'  placeholder="请输入" v-model="info.promptInfo"></iInput>
		</iCard>
		<!-- 财报分析 -->
		<iCard title="财报分析" collapse class="margin-top20">
