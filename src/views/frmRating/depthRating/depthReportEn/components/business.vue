...
<template>
	<div>
		...
		<iCard title="Group and Affiliates" collapse class="margin-top20">
			<iInput :disabled="isDisabled" type='textarea' :autosize='rowRange'  placeholder="Please enter." v-model="info.groupCompany"></iInput>
		</iCard>
		<!-- 重要变更 -->
		<iCard title="Important Changes" collapse class="margin-top20">
			<iInput :disabled="isDisabled" type='textarea' :autosize='rowRange'  placeholder="Please enter." v-model="info.importantChange"></iInput>
		</iCard>
		<!-- 融资信息 -->
		<iCard title="Financing Information" collapse class="margin-top20">
			<iInput :disabled="isDisabled" type='textarea' :autosize='rowRange'  placeholder="Please enter." v-model="info.financingInformation"></iInput>
		</iCard>
		<!-- 业务情况 -->
		<iCard title="business overview" collapse class="margin-top20">
			<iInput :disabled="isDisabled" type='textarea' :autosize='rowRange'  placeholder="Please enter." v-model="info.businessSituation"></iInput>
		</iCard>
		<!-- 搬迁情况 -->
		<iCard title="Relocation Status" collapse class="margin-top20">
			<iInput :disabled="isDisabled" type='textarea' :autosize='rowRange'  placeholder="Please enter." v-model="info.relocation"></iInput>
		</iCard>
		<!-- 敏感信息 -->
		<iCard title="Sensitive Information" collapse class="margin-top20">
			<iInput :disabled="isDisabled" type='textarea' :autosize='rowRange'  placeholder="Please enter." v-model="info.sensitiveInformation"></iInput>
		</iCard>
		<!-- 公司简介 -->
		<iCard title="Company Profile" collapse class="margin-top20">
			<iInput :disabled="isDisabled" type='textarea' :autosize='rowRange'  placeholder="Please enter." v-model="info.companyProfile"></iInput>
		</iCard>
		<!-- 其他补充信息 -->
		<iCard title="Additional Information" collapse class="margin-top20">
			<iInput :disabled="isDisabled" type='textarea' :autosize='rowRange'  placeholder="Please enter." v-model="info.otherSupplementaryInfo"></iInput>
		</iCard>
		<el-row :gutter="50">
			<el-col :span="14">
				<!-- 主营业务及客户情况 -->
		...
		<iCard :title="$t('LK_BEIZHU')" collapse class="margin-top20">
			<iInput :disabled="isDisabled" type='textarea' :autosize='rowRange'  placeholder="Please enter." v-model="info.remark"></iInput>
		</iCard>
