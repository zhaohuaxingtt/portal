...
export const tableTitle = [
  ...
  {props: 'externalAccessAcore', name: '外评', key: 'SPR_FRM_FRMGL_WP', width: 120, tooltip: true},
  {props: 'grade', name: '初步评级', key: 'SUPPLIER_CHUBUPINGJI', width: 120, tooltip: true},
  {props: 'preliminaryStatus', name: '初评状态', key: 'SPR_FRM_CBPJ_CPZT',  width: 120,tooltip: true},
  {props: 'afterGrade', name: '调整后评级', key: 'SPR_FRM_FRMGL_TZHPJ', width: 120, tooltip: true},
  {props: 'source', name: '数据来源', key: 'SPR_FRM_XGYSPJ_SJLY',  width: 120,tooltip: true},
  {props: 'createDate', name: '评级时间', key: 'SPR_FRM_XGYSPJ_PJSJ', width: 150, tooltip: true},
  {props: 'score', name: '调整前得分', key: 'SPR_FRM_CBPJ_TZQDF', width: 120, tooltip: true},
  {props: 'adjustmentScore', name: '调整分', key: 'SPR_FRM_CBPJ_TZF', width: 120, tooltip: true},
  {
  ...
  {props: 'effectFlag', name: '是否有效', key: 'SPR_FRM_CBPJ_SFYX', width: 90, tooltip: true},
