  ...
  <iCard>
    <div class="margin-bottom20 clearFloat">
      <div class="floatright">
        ...
        <!--重新打分-->
        <iButton @click="handleReScoring" :loading="reScoreButtonLoading">{{ $t('SPR_FRM_CBPJ_CXDF') }}</iButton>
        <!--定性打分-->
        <iButton @click="handleQualitativeScoring">{{ $t('SPR_FRM_FRMGL_DXDAF') }}</iButton>
        <!--退回-->
        <iButton @click="handleReturn">{{ $t('LK_TUIHUI') }}</iButton>
        <!--取消-->
        <iButton @click="handleCancel">{{ $t('APPROVAL.CANCEL') }}</iButton>
        <!--转派-->
