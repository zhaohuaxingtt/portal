    ...
    <el-form>
      ...
      <el-row class="margin-bottom20">
        ...
        <el-form-item :label="$t('LK_GONGYINGSHANGMINGCHENG')">
          <iInput :placeholder="$t('LK_QINGSHURU')" v-model="form.nameZh"></iInput>
        </el-form-item>
        <!--统一社会信用代码-->
        ...
        <el-form-item :label="$t('EnterpriseType')">
          <iSelect :placeholder="$t('LK_QINGXUANZE')" v-model="form.enterpriseType">
        ...
        <el-form-item :label="$t('SPR_FRM_FRMGL_XGKS')">
          <iSelect :placeholder="$t('LK_QINGXUANZE')" v-model="form.takeChargeSection">
            <el-option value="" :label="$t('all')"></el-option>
            <el-option
                :value="item.name"
                :label="$i18n.locale === 'zh'  ? item.name : item.nameEn"
      ...
      <el-row class="margin-bottom20">
        ...
        <el-form-item :label="$t('GONGHUO')">
          <iSelect :placeholder="$t('LK_QINGXUANZE')" v-model="form.isActive">
            <!--            <el-option value="" :label="$t('all')"></el-option>-->
            <el-option
                :value="item.name"
                :label="$i18n.locale === 'zh'  ? item.name : item.nameEn"
        ...
        <el-form-item :label="$t('SPR_FRM_FRMGL_DXDFZT')">
          <iSelect :placeholder="$t('LK_QINGXUANZE')" v-model="form.qualitativeScoreStatus">
            <!--            <el-option value="" :label="$t('all')"></el-option>-->
            <el-option
                :value="item.name"
                :label="$i18n.locale === 'zh'  ? item.name : item.nameEn"
        ...
        <el-form-item :label="$t('SPR_FRM_FRMGL_CPJG')">
          <el-row gutter="5" style="display: inline-block">
            <el-col :span="11">
              <iSelect :placeholder="$t('LK_QINGXUANZE')" v-model="form.initialScoreBegin">
                <!--                <el-option value="" :label="$t('all')"></el-option>-->
                <el-option
                    :value="item.name"
                    :label="$i18n.locale === 'zh'  ? item.name : item.nameEn"
            ...
            <el-col :span="11">
              <iSelect :placeholder="$t('LK_QINGXUANZE')" v-model="form.initialScoreEnd">
                <!--                <el-option value="" :label="$t('all')"></el-option>-->
                <el-option
                    :value="item.name"
                    :label="$i18n.locale === 'zh'  ? item.name : item.nameEn"
      ...
      <el-row>
        ...
        <el-form-item :label="$t('SPR_FRM_FRMGL_WP')">
          <el-row gutter="5" style="display: inline-block">
            <el-col :span="11">
              <iSelect :placeholder="$t('LK_QINGXUANZE')" v-model="form.externalAccessScoreStart">
                <!--                <el-option value="" :label="$t('all')"></el-option>-->
                <el-option
                    :value="item.name"
                    :label="$i18n.locale === 'zh'  ? item.name : item.nameEn"
            ...
            <el-col :span="2">-</el-col>
            <el-col :span="11">
              <iSelect :placeholder="$t('LK_QINGXUANZE')" v-model="form.externalAccessScoreEnd">
                <!--                <el-option value="" :label="$t('all')"></el-option>-->
                <el-option
                    :value="item.name"
                    :label="$i18n.locale === 'zh'  ? item.name : item.nameEn"
        ...
        <el-form-item :label="$t('SPR_FRM_FRMGL_SPZT')">
          <iSelect :placeholder="$t('LK_QINGXUANZE')" v-model="form.deepStatus">
            <!--            <el-option value="" :label="$t('all')"></el-option>-->
            <el-option
                :value="item.name"
                :label="$i18n.locale === 'zh'  ? item.name : item.nameEn"
