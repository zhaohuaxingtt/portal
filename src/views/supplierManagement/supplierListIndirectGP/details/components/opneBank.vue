<template>
  <iCard tabCard collapse :title="$t('KAIHUYINHANG')" class="margin-top20">
    <iButton class="btn_class" @click="addBank">新增子银行账户</iButton>
    <iFormGroup
      row="3"
      :rules="bankRules"
      :model="supplierData"
    ...
    >
      <template v-if="$route.query.subSupplierType == 'GP'">
        ...
        <template v-if="bingoType">
          <iFormItem
            prop="settlementBankDTO.countryCode"
            v-permission="SUPPLIER_BASEINFO_BANK_BANKINCOUNTRY_GP"
          >
            <iLabel
          ...
          <!-- 银行所在省份 -->
          <iFormItem
            prop="settlementBankDTO.provinceCode"
            v-permission="SUPPLIER_BASEINFO_BANK_BANKINPROVINCES_GP"
          >
            <iLabel
          ...
          <!-- 银行所在城市/区 -->
          <iFormItem
            prop="settlementBankDTO.cityCode"
            v-permission="SUPPLIER_BASEINFO_BANK_BANKINCITY_GP"
          >
            <iLabel
          ...
          <!-- 银行名称 -->
          <iFormItem
            prop="settlementBankDTO.bankName"
            v-permission="SUPPLIER_BASEINFO_BANK_BANKNAME_GP"
          >
            <iLabel
          ...
          <!-- 银行机构编码 -->
          <iFormItem
            prop="settlementBankDTO.bankCode"
            v-permission="SUPPLIER_BASEINFO_BANK_BANKCODE_GP"
          >
            <iLabel
          ...
          <!-- 银行账号 -->
          <iFormItem
            prop="settlementBankDTO.bankAccount"
            v-permission="SUPPLIER_BASEINFO_BANK_ACCOUNTS_GP"
          >
            <iLabel
        ...
        <!-- 非正式 -->
        <template v-else>
          <iFormItem v-permission="SUPPLIER_BASEINFO_BANK_BANKINCOUNTRY_GP">
          ...
          <!-- 银行所在省份 -->
          <iFormItem v-permission="SUPPLIER_BASEINFO_BANK_BANKINPROVINCES_GP">
          ...
          <!-- 银行所在城市/区 -->
          <iFormItem v-permission="SUPPLIER_BASEINFO_BANK_BANKINCITY_GP">
          ...
          <!-- 银行名称 -->
          <iFormItem v-permission="SUPPLIER_BASEINFO_BANK_BANKNAME_GP">
            <iLabel
              :label="$t('YINGHANGMINCHENG')"
              slot="label"
              icons="iconxinxitishi"
          ...
          <!-- 银行账号 -->
          <iFormItem v-permission="SUPPLIER_BASEINFO_BANK_ACCOUNTS_GP">
      ...
      <template>
        ...
        <template v-if="bingoType">
          ...
          <iFormItem
            ...
            v-permission="SUPPLIER_BASEINFO_BANK_DZYPNAME_GP"
          >
          ...
          <iFormItem
            prop="gpSupplierBankNoteDTO.bankNoteAccount"
            :rules="hanghaoRules(1)"
            v-if="$route.query.subSupplierType == 'GP'"
            v-permission="SUPPLIER_BASEINFO_BANK_DZYPCODE_GP"
          >
          ...
          <iFormItem
            prop="gpSupplierBankNoteDTO.country"
            v-if="$route.query.subSupplierType == 'GP'"
            v-permission="SUPPLIER_BASEINFO_BANK_DZYPCOUNTRY_GP"
          >
          ...
          <iFormItem
            prop="gpSupplierBankNoteDTO.province"
            v-if="$route.query.subSupplierType == 'GP'"
            v-permission="SUPPLIER_BASEINFO_BANK_DZYPPRO_GP"
          >
          ...
          <iFormItem
            prop="gpSupplierBankNoteDTO.city"
            v-if="$route.query.subSupplierType == 'GP'"
            v-permission="SUPPLIER_BASEINFO_BANK_DZYPCITY_GP"
          >
    ...
    <template v-if="$route.query.subSupplierType == 'GP'">
      ...
      >
        <iButton
          ...
          v-permission="SUPPLIER_BASEINFO_COMPANY_BASEINFO_DELBANK_GP"
          >删除</iButton
        >
        ...
        >
          ...
          >
            ...
            <iFormItem
              prop="salaryAccount"
              v-permission="SUPPLIER_BASEINFO_BANK_NMGGZZYZHMC_SON_GP"
            >
              <iLabel
          ...
          <iFormGroup row="1" :model="item" ref="bankRules3">
            ...
            <iFormItem
              :prop="item.remark"
              v-permission="SUPPLIER_BASEINFO_BANK_MARK_SON_GP"
            >
