  ...
  <iPage>
    ...
    >
      <el-form :model="queryForm">
        <el-form-item
          :label="language('LK_YQ_GONGYINGSANGMINGCHEN', '供应商名称')"
        >
          <i-input
            v-model="queryForm.a"
        ...
        <el-form-item
          :label="
            language('LK_YQ_TONGYISHEHUIXINYONGDAIMA', '统一社会信用代码')
          "
        >
          <i-input
            v-model="queryForm.b"
    ...
    <i-card>
      ...
      <div class="editControl floatright margin-bottom20">
        ...
        <i-button @click="">
          {{ language('LK_YQ_DAOCHUQUANBU', '导出全部') }}</i-button
        >
