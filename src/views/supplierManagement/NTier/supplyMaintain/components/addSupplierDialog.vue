...
-->
<template>
  <iDialog :title="language('TIANJIASHANGYOUGONGYINGSHANG','添加上游供应商')"
           width="90%"
           :visible.sync="value"
           show-close
           @close="clearDiolog">
    ...
    <el-row type="flex"
      ...
      <el-col :span="4">
        <iInput v-model="form.supplierName"
                :placeholder="language('GONGYINGSHANGMINGCHEN_SAPHAO','供应商名称/SAP号')"></iInput>
      </el-col>
      <el-col :span="4">
    ...
    <el-table ref="multipleTable"
      ...
      <el-table-column :show-overflow-tooltip="true"
                       align='center'
                       prop="factoryName"
                       :label="language('GONGCHANGMINGCHENG','工厂名称')"></el-table-column>
      <el-table-column :show-overflow-tooltip="true"
                       align='center'
                       prop="address"
    ...
    <iPagination class="margin-bottom20"
                 v-update
