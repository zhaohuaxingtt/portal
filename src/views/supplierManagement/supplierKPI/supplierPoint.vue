...
<template>
  <div>
    ...
    <el-tabs
      ...
      @tab-click="changeTab"
    >
      <el-tab-pane name="PP" :label="language('SHENGCHANGYS', '生产供应商')">
      </el-tab-pane>
      <el-tab-pane name="GP" :label="language('YIBANGONGYS', '一般供应商')">
      </el-tab-pane>
    </el-tabs>
    ...
    <iCard style="margin-top:20px">
      ...
      <div class="table-title">
        <div>
          ...
          <span style="margin-left:10px" class="spanText" v-if="tabledata.length == 0">
            (
            {{
              language(
...
import { categoryManagementAssistantList } from './commonHeardNav/navData'
