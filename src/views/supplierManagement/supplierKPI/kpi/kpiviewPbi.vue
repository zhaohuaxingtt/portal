    ...
    methods: {
      ...
      powerBiUrl() {
        ...
        if (process.env.NODE_ENV === 'production') {
          data = {
            reportId: 'e6372f05-dc65-431a-98f9-da0dbddd0d73',
            workspaceId: 'c272ae69-a6b4-4407-bd0e-f67953de36ce'
          }
          console.log('生产环境')
        } else {
          data = {
            reportId: '078a597d-70cc-4541-86d4-e2cb1b4c1478',
            workspaceId: '876776a9-f959-442e-a011-b4bade0dd862'
          }
          console.log('测试环境')
        }
        getPerformanceKpiOverViewPbi(data).then((res) => {
          if (res.data) {
            this.url = res.data
            this.renderBi()
          }
