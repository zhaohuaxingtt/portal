    ...
    methods: {
      ...
      powerBiUrl() {
        ...
        if (process.env.NODE_ENV === 'production') {
          data = {
            reportId: '0fdf40dc-6ae0-4838-8bd2-5a844eaad3fa',
            workspaceId: 'c272ae69-a6b4-4407-bd0e-f67953de36ce'
          }
          console.log('生产环境')
        } else {
          data = {
            reportId: '041eeb3c-c5f4-4dc3-bbc1-f0bb5ce66760',
            workspaceId: '876776a9-f959-442e-a011-b4bade0dd862'
          }
          console.log('测试环境')
        }
        getHistoryDeptSynthesisPbi(data).then((res) => {
          if (res.data) {
            this.url = res.data
            this.renderBi()
          }
