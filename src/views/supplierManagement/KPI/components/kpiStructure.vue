          ...
          >
                <div class="cell">
                    <div :class="item.children.length>0?'content kpi-module second-before second-after':'content kpi-module second-before'">
                        ...
                        <div class="case">
                            <label>比重(%)</label>
                            <iInput class="kpi-input" v-model="item.weight" @input="item.weight=item.weight.replace(/[^\d]/g,'')"></iInput>
                        </div>
                    ...
                    >
                        <div class="cell third-cell" :class="index3<item.children.length-1?'cloum-before':''">
                            <div :class="lev3.children.length>0?'content kpi-module third-border-before third-border-after':'content kpi-module third-border-before'">
                                ...
                                <div class="case">
                                    <label>比重(%)</label>
                                    <iInput class="kpi-input" v-model="lev3.weight"  @input="lev3.weight=lev3.weight.replace(/[^\d]/g,'')"></iInput>
                                </div>
                        ...
                        >
                                ...
                                <div class="case">
                                    <label>比重(%)</label>
                                    <iInput class="kpi-input" v-model="lev4.weight" @input="lev4.weight=lev4.weight.replace(/[^\d]/g,'')"></iInput>
                                </div>
