           ...
           <iCard style="margin-top:20px">
               <div class="top">
                   <div class="searchOptions">
                    ...
                    <div>
                        <input type="file" id="file" accept=".csv, application/vnd.ms-excel, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" @change="upfileChange($event)" style="display:none;" />
                    ...
                    <table cellspacing="0" cellpadding="0">
                        ...
                        <tr v-for="(x,index) in tbodyData" :key="index">
                            ...
                            <td>
                                ...
                                <el-tooltip class="item" effect="light" :content="x.nameZh" placement="top">
                                    <div>{{x.nameZh}}</div>
                                </el-tooltip>
                            </td>
                            <td><div>{{x.all}}</div></td>
