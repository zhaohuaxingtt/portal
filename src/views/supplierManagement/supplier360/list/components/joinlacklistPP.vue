...
-->
<template>
  <iDialog @close="closeDiolog()" :visible.sync="value" width="85%" top="2%">
    <div slot="title" class="headerTitle">
      <span>{{
        language('JIARUHEIMINGDANSHENGCHANCAIGOU', '加入黑名单 - 生产采购')
      }}</span>
    </div>
    <div class="box">
      <el-form
