<template>
  <i-card class="table">
    <div class="btn flex-end-center">
      <i-button @click="download" :disabled="isDownload">{{
        language('下载')
      }}</i-button>
      <button-table-setting @click="$refs.downloadTable.openSetting()" />
    </div>
    <div class="tableList">
      <iTableCustom
        ref="downloadTable"
