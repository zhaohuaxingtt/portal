...
<script>
    ...
    export default {
            ...
            role() {
                if (this.roleList.length == 1) {
                    ...
                    if (Linie) {        // 采购员 采购员视觉
                        ...
                        this.username = '7'
                        this.btnsgroup1 = ['CSE-1', 'CSE-1(Spare)']
                        return 'CSE-1'
                    } else if (CGBZ_WF) {
                        this.btnsgroup1 = ['CS', 'CS(Spare)']
                        return 'CGBZ_WF'
                    ...
                    if (KZ && Linie) {
                        ...
                        this.username = '4'
                        this.btnsgroup1 = ['CSM', 'CSM(Spare)', 'Linie', 'Linie(Spare)']
                        return 'KZZL&&Linie'
                    } else if (KZZL && !Linie) {
                        this.username = '4'
                        this.btnsgroup1 = ['CSM', 'CSM(Spare)']
                        ...
                        this.username = '7'
                        this.btnsgroup1 = ['CSE-1', 'CSE-1(Spare)', 'Linie', 'Linie(Spare)']
                        return 'CSE-1&&Linie'
                    } else if (GZ && !Linie) {
                        this.username = '7'
                        this.btnsgroup1 = ['CSE-1', 'CSE-1(Spare)']
        ...
        mounted() {
            ...
            } else if (this.role == 'CSE-1') { // 股长
                this.currentView = 'zfgsj'
            } else if (this.role == 'CSE-1&&Linie') { // 股长&&采购员
                this.currentView = 'zfgsj'
            } else if (this.role == 'CSM') { // 科室
                this.currentView = 'zfkssj'
            } else if (this.role == 'KZZL&&Linie') { // 科室&&采购员
                this.currentView = 'zfkssj'
            } else if (this.role == 'Linie') { // 采购员
                this.currentView = 'zfcgysj'
            } else if (this.role == 'CGBZ_WF') { // 外方部门视图
            ...
            } else if (this.role == 'ZYCGKZ_WF') {// 外方科室视图
            ...
            exchangeSelectState(item, index) {
                if (item == 'CS') { // 部门
                    ...
                    if (this.role == 'ZYCGKZ_WF') {
                        ...
                        this.username = '3'
                        this.currentView = 'zfkssj'
                    } else if (this.role == 'KZZL&&Linie' || this.role == 'CSM') {
                        this.username = '4'
                        this.currentView = 'zfkssj'
                    }
                    ...
                    if (this.role == 'ZYCGKZ_WF') {
                        ...
                        this.username = '5'
                        if (this.role == 'KZZL&&Linie' || this.role == 'CSM') {
                            this.username = '6'
                        }
                        this.currentView = 'pfjzfkssj'
                    }
                } else if (item == 'CSE-1(Spare)') { // 股长
                    this.username = '9'
                    if (this.role == 'CSE-1&&Linie') {
                        this.username = '10'
                    }
                    this.currentView = 'pfjzfgsj'
                } else if (item == 'CSE-1') { // 股长
                    this.username = '7'
                    this.currentView = 'zfgsj'
                } else if (item == 'Linie') { // 采购员视觉
                    if (this.role == 'Linie') { // 采购员
                        this.username = 8
                    } else if (this.role == 'CSE-1&&Linie' || this.role == 'CSE-1') { // 股长&&采购员 || 股长
                        this.username = '7'
                    } else if (this.role == 'CS&&Linie') { // 部长助理&&采购员
                        this.username = '2'
                    } else if (this.role == 'KZZL&&Linie') { // 科长助理&&采购员
                        this.username = '4'
                    }
                    this.currentView = 'zfcgysj'
                } else if (item == 'Linie(Spare)') { // 采购员附件视觉
                    this.username = '6'
                    if (this.role == 'CSE-1&&Linie') { // 股长&&采购员
                        this.username = '10'
                    } else if (this.role == 'Linie') { // 采购员
                        this.username = '12'
                    }
