        ...
        data() {
            return {
                formData: {
                    ...
                    workspaceId: process.env.EKL_BAOBIAO_PARAMS.wfkssj.workspaceId,
                    reportId: process.env.EKL_BAOBIAO_PARAMS.wfkssj.reportId,
                    datasets: process.env.EKL_BAOBIAO_PARAMS.wfkssj.datasets,
