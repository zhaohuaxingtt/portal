        ...
        data() {
            return {
                formData: {
                    ...
                    workspaceId: process.env.EKL_BAOBIAO_PARAMS.zfgsj.workspaceId,
                    reportId: process.env.EKL_BAOBIAO_PARAMS.zfgsj.reportId,
                    datasets: process.env.EKL_BAOBIAO_PARAMS.zfgsj.datasets,
