        ...
        data() {
            return {
                formData: {
                    ...
                    workspaceId: process.env.EKL_BAOBIAO_PARAMS.wfbmsj.workspaceId,
                    reportId: process.env.EKL_BAOBIAO_PARAMS.wfbmsj.reportId,
                    datasets: process.env.EKL_BAOBIAO_PARAMS.wfbmsj.datasets,
