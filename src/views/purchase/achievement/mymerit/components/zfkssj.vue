        ...
        data() {
            return {
                formData: {
                    ...
                    workspaceId: process.env.EKL_BAOBIAO_PARAMS.zfkssj.workspaceId,
                    reportId: process.env.EKL_BAOBIAO_PARAMS.zfkssj.reportId,
                    datasets: process.env.EKL_BAOBIAO_PARAMS.zfkssj.datasets,
