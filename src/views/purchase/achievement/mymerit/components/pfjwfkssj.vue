    ...
    data() {
      return {
        formData: {
          ...
          workspaceId: process.env.EKL_BAOBIAO_PARAMS.pfjwfkssj.workspaceId,
          reportId: process.env.EKL_BAOBIAO_PARAMS.pfjwfkssj.reportId,
          datasets: process.env.EKL_BAOBIAO_PARAMS.pfjwfkssj.datasets,
