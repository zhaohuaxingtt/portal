  ...
  data() {
    return {
      formData: {
        ...
        workspaceId:
          EKL_BAOBIAO_PARAMS[process.env.NODE_ENV].zfbmsj.workspaceId,
        reportId: EKL_BAOBIAO_PARAMS[process.env.NODE_ENV].zfbmsj.reportId,
        datasets: EKL_BAOBIAO_PARAMS[process.env.NODE_ENV].zfbmsj.datasets,
        username: '',
        roles: []
      }
    }
