    ...
    data() {
      return {
        formData: {
          ...
          workspaceId: process.env.EKL_BAOBIAO_PARAMS.pfjzfkssj.workspaceId,
          reportId: process.env.EKL_BAOBIAO_PARAMS.pfjzfkssj.reportId,
          datasets: process.env.EKL_BAOBIAO_PARAMS.pfjzfkssj.datasets,
