export const tableTitle = [
    ...
    {props: 'kslPriceSource', name: 'KSL来源价格', key: 'LK_KSLLAIYUANJIAGE', width: 120, tooltip: true,iconText: 'C:正式订单价 D:定点价格 T:目标价 F:上期正式订单价 M:手工', iconTextKey: 'LK_QRJG',icon:'iconxinxitishi'},
