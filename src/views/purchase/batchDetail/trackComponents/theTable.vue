                ...
                try {
                    ...
                    if (res.result) {
                        ...
                        this.tableListData.map((item) => {
                            ...
                            this.$set(item, 'originPrice', item.priceConfirm?toThousands(item.priceConfirm):'')
                            this.$set(item, 'price', item.price?toThousands(item.price):'')
                            this.$set(item, 'priceConfirm', item.priceConfirm?toThousands(item.priceConfirm):'')
                            this.$set(item, 'carconfigSixcodeVolumn', item.carconfigSixcodeVolumn?toThousands(item.carconfigSixcodeVolumn):'')
                            this.$set(item, 'confirmQuantity', item.confirmQuantity?toThousands(item.confirmQuantity):'')
                            this.$set(item, 'procAmount', item.procAmount?toThousands(item.procAmount):'')
                            this.$set(item, 'janPrice', item.janPrice?toThousands(item.janPrice):'')
                            this.$set(item, 'febPrice', item.febPrice?toThousands(item.febPrice):'')
                            this.$set(item, 'marPrice', item.marPrice?toThousands(item.marPrice):'')
                            this.$set(item, 'aprPrice', item.aprPrice?toThousands(item.aprPrice):'')
                            this.$set(item, 'mayPrice', item.mayPrice?toThousands(item.mayPrice):'')
                            this.$set(item, 'junPrice', item.junPrice?toThousands(item.junPrice):'')
                            this.$set(item, 'julPrice', item.julPrice?toThousands(item.julPrice):'')
                            this.$set(item, 'augPrice', item.augPrice?toThousands(item.augPrice):'')
                            this.$set(item, 'sepPrice', item.sepPrice?toThousands(item.sepPrice):'')
                            this.$set(item, 'octPrice', item.octPrice?toThousands(item.octPrice):'')
                            this.$set(item, 'novPrice', item.novPrice?toThousands(item.novPrice):'')
                            this.$set(item, 'decPrice', item.decPrice?toThousands(item.decPrice):'')
                            this.$set(item, 'lasting', item.lasting?toThousands(item.lasting):'')
                            this.$set(item, 'average', item.average?toThousands(item.average):'')
