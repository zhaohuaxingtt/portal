export const tableTitle = [
    ...
    {props: 'carconfigSixcode', name: '车型代码', key: 'EKL_YJGL_CXDM', tooltip: true,},
    {props: 'factoryCode', name: '采购工厂', key: 'EKL_YJGL_CGGC', width: 100,tooltip: true,},
    {props: 'supplierName', name: '供应商', key: 'EKL_YJGL_GYS', tooltip: true, width: 240},
    ...
    // {props: 'quantity', name: '确认数量', key: 'EKL_YJGL_QRSL', tooltip: true},
    {props: 'priceConfirm', name: '确认价格', key: 'EKL_YJGL_QRJG', width: 150, tooltip: true, iconText: '确认价格', iconTextKey: 'EKL_YJGL_QRJG', required: true},
    {props: 'confirmPrice', name: '参考价格', key: 'EKL_YJGL_CKJG', width: 150, tooltip: true, iconText: '参考价格', iconTextKey: 'EKL_YJGL_CKJG', required: true},
    {props: 'priceSource', name: '参考价格来源', key: 'EKL_YJGL_CKJGLY', width: 150, tooltip: true,},
    {props: '_isConfirm', name: '确认状态', key: 'EKL_YJGL_QRZT', width: 100, tooltip: true,},
    {props: 'procAmount', name: '采购金额', key: 'EKL_CAIGOUJINE', width: 150, tooltip: true,},
    {props: 'carconfigSixcodeVolumn', name: '全年产量', key: 'EKL_YJGL_QNCL', width: 100, tooltip: true,},
    {props: 'configName', name: '配置', key: 'EKL_YJGL_PEIZ', width: 120, tooltip: true,},
    {props: 'csGroupName', name: '材料组', key: 'EKL_CAILIAOZU', width: 120, tooltip: true,},
    ...
    {props: 'buyerName', name: '采购员', key: 'EKL_YJGL_CGY', width: 80, tooltip: true,},
    {props: 'idxCode', name: '索引号', key: 'EKL_YJGL_SYH', width: 80, tooltip: true,},
    {props: 'carconfigVolumn', name: '数量', key: 'EKL_YJGL_SHUL', width: 80, tooltip: true,},
];
