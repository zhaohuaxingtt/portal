                ...
                try {
                    ...
                    if (res.result) {
                        ...
                        this.tableListData.map((item) => {
                            ...
                            item.carconfigSixcodeVolumn = toThousands(item.carconfigSixcodeVolumn)
                            item.janCarvolumn = toThousands(item.janCarvolumn)
                            item.febCarvolumn = toThousands(item.febCarvolumn)
                            item.marCarvolumn = toThousands(item.marCarvolumn)
                            item.aprCarvolumn = toThousands(item.aprCarvolumn)
                            item.mayCarvolumn = toThousands(item.mayCarvolumn)
                            item.junCarvolumn = toThousands(item.junCarvolumn)
                            item.julCarvolumn = toThousands(item.julCarvolumn)
                            item.augCarvolumn = toThousands(item.augCarvolumn)
                            item.sepCarvolumn = toThousands(item.sepCarvolumn)
                            item.octCarvolumn = toThousands(item.octCarvolumn)
                            item.novCarvolumn = toThousands(item.novCarvolumn)
                            item.decCarvolumn = toThousands(item.decCarvolumn)
