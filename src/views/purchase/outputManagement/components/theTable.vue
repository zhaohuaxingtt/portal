    ...
    <iCard>
        <div class="margin-bottom20 clearFloat">
            <div class="floatright">
                <!--返回上级-->
                <iButton @click="goBack" v-if="isAuth(whiteBtnList,'OUTPUT_MANAGEMENT_PAGE_RETURNSTEP')">{{ $t('EKL_FHSJ') }}</iButton>
                <!--下载模板-->
                <iButton @click="downFile" v-if="isAuth(whiteBtnList,'OUTPUT_MANAGEMENT_PAGE_DOWNLOAD')" >{{ $t('EKL_XZMB') }}</iButton>
                <!--上传产量-->
                <iButton @click="uploadFile" v-if="isAuth(whiteBtnList,'OUTPUT_MANAGEMENT_PAGE_UPLOAD')">{{ $t('EKL_SCCL') }}</iButton>
                <!--删除-->
