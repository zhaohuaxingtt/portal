...
-->
<template>
  <iPage class="partsItemConfig" v-permission.auto="PARTSITEMCONFIG_PAGE|零件采购类型规则维护-页面">
      ...
      <iCard :title="language('LINGJIANLEIXINGPEIZHI','零件类型配置')">
          <template v-slot:header-control>
              <iButton @click="save()" :loading="saveLoading" v-permission.auto="PARTSITEMCONFIG_SAVEBTN|零件采购类型规则维护-保存按钮">{{language('BAOCUN','保存')}}</iButton>
          </template>
          <!-- 表单区域 -->
          <el-table
            :data="tablePtData"
