 ...
 * @LastEditTime: 2021-12-13 21:31:48
      ...
      <div class="header">
        ...
        <div v-show="!downLoadFlag">
          ...
          <uploadButton ref="uploadButtonAttachment"
                        ...
                        @uploadedCallback="handleUploadFile($event)"
                        class="margin-left20" />
      ...
      <iCard style="margin-top:20px"
        ...
        <div class="formItem">
          ...
          <div class="flex earlyWarning">
            ...
            <iButton :disabled="linieList?linieList.length===mulitList.length:''"
      ...
      <iCard style="margin-top:20px"
        ...
        <template v-slot:header>
          <div class="flex header">
            ...
            <div v-show="!downLoadFlag"
                 class="flex">
              <el-upload class="upload margin-right10"
                         multiple
...
export default {
  ...
  methods: {
    ...
    handleUploadFile (content) {
      iMessage.success("上传成功","上传成功")
      this.PdfUrl = content.id
    },
