  ...
  <div class="custom-select">
    <el-popover placement="bottom" trigger="click" @show="handleShow" @hide="handleHide" :popper-class="`${popoverClass} custom-select-popover`" :disabled="disabled" ref="selectPopover">
      <div class="search-wrapper" v-if="typeof searchMethod === 'function'">
        <el-input v-model="query" :placeholder="language('KAISHISOUSUOBA','开始搜索吧...')" @input="handleInputChange" ref="searchInput"></el-input>
      </div>
      ...
      <el-input :class="`${inputClass} custom-select-input`" v-model="inputData" slot="reference" :disabled="disabled" :readonly="true" :placeholder="language('QINGXUANZHE','请选择')" :title="inputData" ref="selectInput"></el-input>
    </el-popover>
  </div>
</template>
