  ...
  <iCard class="margin-top20">
    <div class="margin-bottom20 clearFloat">
      <div class="floatright">
        <iButton
          @click="handleFabuNotice"
          :disabled="
            btnStatue || selectedRow.length === 0 || selectedRow.length > 1
          "
        >
          {{ language('NEWS_FABU', '发布') }}
        </iButton>
        <iButton @click="handleAddNotice">{{
          language('NEWS_XINJIANGONGGAO', '新建公告')
        }}</iButton>
    ...
    <div class="card--body">
      ...
      >
        ...
        <el-table-column
          ...
          :label="language('NEWS_GONGGAOBIAOTI', '公告标题')"
        >
          <template slot-scope="scope">
            <div class="tooltip">
              <img
        ...
        <el-table-column
          align="center"
          min-width="80"
          :label="language('NEWS_GONGGAOLEIXING', '公告类型')"
        >
          <template slot-scope="scope">
        ...
        <el-table-column
          align="center"
          min-width="50"
          :label="language('NEWS_GONGGAOZHUANGTAI', '公告状态')"
        >
          <template slot-scope="scope">
        ...
        <el-table-column
          align="center"
          min-width="80"
          :label="language('NEWS_FABUSHIJIAN', '发布时间')"
        >
          <template slot-scope="scope">
            <span>{{
              scope.row['status'] > 0 ? scope.row['publishDate'] : ''
            }}</span>
          </template>
        </el-table-column>
        <el-table-column
          align="center"
          min-width="80"
          :label="language('NEWS_FABUREN', '发布人')"
        >
          <template slot-scope="scope">
        ...
        <el-table-column
          align="center"
          min-width="50"
          :label="language('NEWS_DIANJILIANG', '点击量')"
        >
          <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    handleDelete() {
      ...
      this.$confirm(
        this.language('NEWS_QQRSFSCXZGG', '请确认是否删除选中公告？'),
          ...
          .then((res) => {
            if (res.code == 200) {
              this.$message.success(
                this.language('NEWS_SHANCHUCHENGGONG', '删除成功')
              )
              this.$emit('getTableList')
            }
          })
