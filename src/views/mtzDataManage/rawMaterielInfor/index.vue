<template>
  <div class="main">
                  ...
                  <el-row gutter='24'>
                      <el-col :span='8'>
                          <iFormItem :label='searchLabel.generalCategoryCode'>
                              <iInput v-model="searchContent.generalCategoryCode" placeholder='请输入'></iInput>
                          </iFormItem>
                      </el-col>
                      <el-col :span='8'>
                          <iFormItem :label='searchLabel.generalCategoryNameZh'>
                              <iInput v-model="searchContent.generalCategoryNameZh" placeholder='请输入'></iInput>
                          </iFormItem>
                      </el-col>
                      <el-col :span='8'>
                          <iFormItem :label='searchLabel.generalCategoryNameEn'>
                              <iInput v-model="searchContent.generalCategoryNameEn" placeholder='请输入'></iInput>
                          </iFormItem>
                      </el-col>
                  </el-row>
                  <el-row gutter='24' >
      ...
      <div class="tabelList">
          <iCard>
              <div class="btnList">
                  ...
                  <iButton @click="loseActive" :disabled='loseActiveBtnDis'>失效</iButton>
      ...
      <dialogPage v-if='showDialog' :show.sync='showDialog' :propItem='propItem' @getRawMeterielPage='getRawMeterielPage'></dialogPage>
  </div>
</template>
...
import {getRawPage,exportRawExcel,delRawPageItems,changeSta} from '@/api/materiel/rawMaterielInfor'
import buttonDownload from '@/components/buttonDownload'
// import { float } from 'html2canvas/dist/types/css/property-descriptors/float';

export default {
    components:{iSearch,iButton,iInput,iSelect,iPagination,iFormItem,iCard,iTabelCustom,dialogPage,buttonDownload},
    mixins:[pageMixins],
    computed:{},
    data(){
        return{
