    ...
    >
      <iFormItem :label="language('原材料编号大类')" prop="generalCategoryCode">
        <iInput
          ...
          :disabled="propItem.id"
          maxLength="2"
          @input="limitNumber"
        ></iInput>
      </iFormItem>
      <iFormItem
        :label="language('原材料名称(中文)')"
        prop="generalCategoryNameZh"
      >
        <iInput
          v-model="formContent.generalCategoryNameZh"
          :placeholder="language('请输入')"
          :disabled="edit"
        ></iInput>
      </iFormItem>
      <iFormItem
        :label="language('原材料名称(英文)')"
        prop="generalCategoryNameEn"
      >
        <iInput
          v-model="formContent.generalCategoryNameEn"
          :placeholder="language('请输入')"
          :disabled="edit"
        ></iInput>
      </iFormItem>
      <iFormItem :label="language('大类元素简称')" prop="generalShortName">
        <iInput
          v-model="formContent.generalShortName"
          :placeholder="language('请输入')"
          :disabled="edit"
        ></iInput>
      </iFormItem>
...
export default {
  ...
  created() {
    if (this.propItem.generalCategoryCode) {
      ...
      this.formContent.generalCategoryNameZh =
        this.propItem.generalCategoryNameZh
      this.formContent.generalCategoryNameEn =
        this.propItem.generalCategoryNameEn
