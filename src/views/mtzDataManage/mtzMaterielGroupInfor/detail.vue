<template>
  <iPage>
    ...
    <tableTransfer
      ...
      :placeholder="$t('请输入零件材料组编号/名称/科室')"
    ...
    <tableTransfer
      v-if="$route.query.id"
      :title="$t('零件六位号')"
      :sub-left-title="$t('零件六位号列表')"
      :sub-right-title="$t('已有关联列表')"
      :placeholder="$t('请输入零件材料组编号或名称')"
      :left-null-select-tips="$t('请选择源零件六位号')"
      :right-null-select-tips="$t('请选择已关联零件六位号')"
