...
import {CbdSaveList, CbdChangeList, CbdDeleteList, dataDic, getunitSelect} from '@/api/materiel/partsMaterialGroup'
export default {
    ...
    getCbdTableList() {
      ...
      dataDic(keys,parentId).then(res => {
        if(res.code == 200) {
          ...
          Vue.set(this.extraData, 'cbdPreseMap', arrayToMap(CATEGORY_CBD_SETTING, 'code', 'name') )
