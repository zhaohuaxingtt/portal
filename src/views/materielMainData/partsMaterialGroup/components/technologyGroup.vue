...
export default {
  ...
  created() {
    ...
    let parentId = -1
    dataDic(keys,parentId).then((val) =>{
      if(val.code == 200){
  ...
  methods: {
    ...
    newTechnology() {
      window.open('/portal/#/materielData/material-group/detail/add-technology?categoryId='+this.categoryId)
    },
    goDetail(row) {
      if(this.readOnly){
        window.open('/portal/#/materielData/material-group/detail/add-technology?categoryId='+this.categoryId+'&stuffId='+row.id+'&readOnly=1')
      }else{
        window.open('/portal/#/materielData/material-group/detail/add-technology?categoryId='+this.categoryId+'&stuffId='+row.id)
      }
