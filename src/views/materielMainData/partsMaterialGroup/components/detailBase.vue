<template>
  <iCard title="基础信息" header-control collapse> 
    ...
    <div class="form-item">
      ...
      >
        <el-row :gutter="20">
          <el-col :span="6">
            <iFormItem 
            :label='formDataLabel.categoryCode'
            prop="categoryCode"
            >
              <iInput 
          ...
          <el-col :span="6">
            ...
            prop="categoryNameDe"
            >
              <iInput :placeholder="formDataLabel.inputPlaceholder" 
          ...
          <el-col :span="6">
            <iFormItem 
            :label='formDataLabel.categoryMemo'
            >
              <iInput 
              :placeholder="formDataLabel.inputPlaceholder" 
          ...
          <el-col :span="6">
            <iFormItem 
            :label='formDataLabel.isFixAsset'
            prop="isFixAsset"
            >
              <iSelect 
    ...
    <div  v-if="categoryId" >
      ...
      <div class="iButton-end margin-bottom20">
        ...
        <div style="display:flex;justify-content: flex-end">
          ...
          <div v-if="!readOnly" style="margin-left:8px">
            ...
            <iButton @click="deleteSixParts" :disabled='selectTableData.length == 0'>删除</iButton>
          </div>
        </div>
      </div>
      <iTableCustom
      ...
      ></iPagination>
      <basic-i-dialog v-if="newAddDialogVisible" :dialogVisible="newAddDialogVisible" @changeVisible="changeBasicVisible" 
      :editPart="editTableData" :addTableData='addTableData' @initPartMaterialDetail="initPartMaterialDetail" 
      :categoryIdParent='categoryId' :readOnly='readOnly'>
      </basic-i-dialog>
    </div>
    </div>
  </iCard>
...
<script>
import {iCard,iButton,iInput,iFormItem,iSelect, iMessage,iPagination} from 'rise'
import iTableCustom from '@/components/iTableCustom'
import BasicIDialog from './basicIDialog.vue'
import {pageMixins} from '@/utils/pageMixins'
import {sixPartNumList, savePartsMaterial, deleteSizeParts, partMaterialDetail,getSixnumDetail,dataDic} from '@/api/materiel/partsMaterialGroup'
export default {
  components: {iCard,iButton,iInput,iFormItem,iSelect,iTableCustom,BasicIDialog,iPagination},
  mixins:[pageMixins],
  props:{
    readOnly:{
      type:Boolean,
  ...
  methods:{
    ...
    initPartMaterialDetail() {
      ...
      if(this.categoryId === '') {
        ...
        partMaterialDetail(this.categoryId).then((res) => {
          ...
          this.$emit('code-nameZh',this.formData.categoryCode,this.formData.categoryNameZh)
    ...
    closeWindow(){
      ...
      if(this.$route.query.id && (JSON.stringify(newData) != JSON.stringify(oldData))){
