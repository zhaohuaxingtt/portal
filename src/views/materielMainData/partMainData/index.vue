...
export default {
  ...
  methods: {
    ...
    handleSelectionChange(val) {
      ...
      // let allselected = []
      // if(val.length > 0){
      //   active = val.filter((item)=>{
      //     return item.partStatusDesc=='激活' || item.partStatusDesc == '草稿'
      //   })
      //   loseActive = val.filter((item)=>{
      //       return item.partStatusDesc=='失效' || item.partStatusDesc == '草稿'
      //   })
      //   allselected = val.filter((item)=>{
      //     return item.partStatusDesc == '激活' && item.partStatusDesc == '失效' && item.partStatusDesc == '草稿'
      //   })
      //   if(allselected.length > 0){
      //     this.unLoseActiveBtn = true
      //     this.unActiveBtn = true
      //   }else if(active.length == val.length){
      //     this.unLoseActiveBtn = false
      //   }else if(loseActive.length == val.length){
      ...
      // }
      // if(val.length > 0){
      //   let selectedDesc = val.map((item)=>{
      //     return item.partStatusDesc
      //   })
      //   if(selectedDesc.includes('草稿') && selectedDesc.includes('激活') && selectedDesc.includes('失效') ){
      //     this.unLoseActiveBtn = true
      //     this.unActiveBtn = true
      //   }else if(selectedDesc.includes('草稿')&& selectedDesc.includes('失效')){
      //     this.unActiveBtn = false
      //     this.unLoseActiveBtn = true
      //   }else if(selectedDesc.includes('草稿') && selectedDesc.includes('激活')){
      //     this.unLoseActiveBtn = false
      //     this.unActiveBtn = true

      //   }else if(selectedDesc.includes('失效') && selectedDesc.includes('激活')){

      //     this.unLoseActiveBtn = true
      //     this.unActiveBtn = true
      //   }else if((selectedDesc.includes('草稿') || selectedDesc.includes('失效') )  && selectedDesc.includes('激活')){

      //     this.unLoseActiveBtn = false
      //     this.unActiveBtn = true
      //   }else if((selectedDesc.includes('草稿') || selectedDesc.includes('激活')) && selectedDesc.includes('失效')){

      //     this.unActiveBtn = false
      //     this.unLoseActiveBtn = true
      //   }else if( selectedDesc.includes('失效')){
      //     this.unActiveBtn = false
      //     this.unLoseActiveBtn = true
      //   }else if(selectedDesc.includes('激活')){
      //      this.unLoseActiveBtn = false
      //     this.unActiveBtn = true
      //   }
      //   else if(selectedDesc.includes('草稿')){
      //     this.unLoseActiveBtn = false
      //     this.unActiveBtn = false
      //   }
      // }else{
