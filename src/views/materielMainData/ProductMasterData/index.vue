            ...
            <el-col :span="8">
              <iFormItem :label="language('产品组编号')">
                <iInput
                  ...
                  v-model="searchContent.productGroupCode"
                ></iInput>
              </iFormItem>
            </el-col>
            <el-col :span="8">
              <iFormItem :label="language('产品组名称(中)')">
                <iInput
                  :placeholder="language('请输入')"
                  v-model="searchContent.productGroupNameZh"
                ></iInput>
              </iFormItem>
            </el-col>
            <el-col :span="8">
              <iFormItem :label="language('产品组名称(德)')">
                <iInput
                  :placeholder="language('请输入')"
                  v-model="searchContent.productGroupNameDe"
                ></iInput>
              </iFormItem>
            </el-col>
          </el-grow>
...
export default {
  ...
  methods: {
    ...
    edit() {
      openUrl(
        `/materielData/product-message/edit?id=${this.selectedItem[0].id}`
      )
