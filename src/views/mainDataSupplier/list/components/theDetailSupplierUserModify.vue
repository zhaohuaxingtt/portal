  ...
  >
    ...
    >
      ...
      <iFormItem :label="language('职位')" prop="position">
        <iInput v-model="detail.position" :placeholder="language('请输入')" />
      </iFormItem>
      ...
      <iFormItem :label="language('联系电话')" prop="telephoneO">
        <iInput
      ...
      <iFormItem :label="language('是否有效')" prop="status">
        <iSelect v-model="detail.status" disabled>
          ...
          <el-option :value="2" label="受控" />
        </iSelect>
      </iFormItem>
      <iFormItem :label="language('是否超期')" prop="materialGroupCode">
