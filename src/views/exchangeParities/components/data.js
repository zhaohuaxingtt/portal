...
export const PARITIES_EDIT_COLUMNS=[
    ...
    },
    {
        ...
        customRender: (h, scope,column,extraData) => {
            ...
            return <paritiesCodeSelect row={scope.row} type='oriCode' selectOptions = {extraData.currencyCode}></paritiesCodeSelect>
        }
    },
    {
        i18n:'目标货币编码',
        ...
        customRender: (h, scope,column,extraData) => {
            ...
            return <paritiesCodeSelect row={scope.row} selectOptions = {extraData.currencyCode}></paritiesCodeSelect>
        }
    },
    {
        i18n:'汇率',
    ...
    },
    {
        ...
        customRender:(h,scope)=>{
            ...
            return <paritiesSelectTime row={scope.row} type='activeTime'></paritiesSelectTime>
        }
    },
    {
        i18n:'生效结束时间',
    ...
    },
    {
        ...
        customRender:(h,scope)=>{
            ...
            return <paritiesSelectActive row={scope.row} type='isEffect'></paritiesSelectActive>
        }
    }
]