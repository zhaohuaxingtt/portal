 ...
 * @FilePath: \front-site-gpd:\front-portal\front-portal\src\views\meeting\managementHall\mbdlMeeting\component\newAddTopic.vue
-->
<template>
  <!--转派-->
  <iDialog
      ...
      >
        <div class="row-box">
          ...
          <iFormItem
            ...
            class="item"
          >
            <iLabel :label="$t('上会时间')" slot="label" required></iLabel>
            <iInput
...
.file-list {
  ...
  li {
    ...
    .download {
      ...
      color: #67C23A;
      white-space: nowrap;
      border-bottom: #67C23A solid 1px;
    }
    .delete {
      height: 100%;
      width: 35px;
